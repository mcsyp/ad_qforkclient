...
#define RCC_I2C_SCL         RCC_AHBPeriph_GPIOB
#define PIN_I2C_SCL         GPIO_Pin_6

#define GPIO_PORT_I2C_SDA   GPIOB
#define RCC_I2C_SDA         RCC_AHBPeriph_GPIOB
...
static rt_size_t stm32_i2c_recv_bytes(I2C_TypeDef *I2Cx, struct rt_i2c_msg *msg)
{
    ...
    while (len--)
    {
        ...
        msg->buf[bytes++] = (rt_uint8_t)I2Cx->RXDR;
    }
    ...
    for (i = 0; i < num; i++)
    {
        ...
        if (!(msg->flags & RT_I2C_NO_START))
        {
            ...
            if (msg->flags & RT_I2C_RD) {
                I2C1->CR2 |= I2C_CR2_AUTOEND | I2C_CR2_RD_WRN | (msg->len<<16) | (msg->addr<<1);
            }
            else {
                I2C1->CR2 |= I2C_CR2_AUTOEND | (msg->len<<16) | (msg->addr<<1);
            }
            I2C_GenerateSTART(I2C1, ENABLE);
            /*
            if (msg->flags & RT_I2C_RD)
...
int rt_hw_i2c_init(void)
{
...
#ifdef RT_USING_I2C_BITOPS
    RCC_AHBPeriphClockCmd(RCC_I2C_SCL | RCC_I2C_SDA, ENABLE);
    ...
    I2C_InitStructure.I2C_Timing = 0xB01A4B;
